"""
Django settings for charuthaproj project.
...
SECRET_KEY = 'django-insecure-mbh2w(%kuyrlxq1j!ks11z09(zd)d^qwy--b=7opn5ck_(7jbg'
...
ROOT_URLCONF = 'charuthaproj.urls'
...
WSGI_APPLICATION = 'charuthaproj.wsgi.application'
