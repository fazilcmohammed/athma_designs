...
const DigitalSolutions = () => {
  return (
    ...
    <section className="container mx-auto px-6 py-12 flex flex-col md:items-center ">
      ...
      <p className="text-gray-900 font-bold text-center uppercase text-sm">Digital Solutions. Digital Results</p>
        ...
        <img
          ...
          alt="The Complete Digital Transformation Experience"
