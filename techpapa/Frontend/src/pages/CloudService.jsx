  ...
  return (
    <>
      ...
      <div className="w-full md:w-1/2">
        <p className="text-red-600 font-bold uppercase">// go Cloud</p>
        <h2 className="text-3xl font-bold text-gray-900 mt-2">
        Making The Cloud Sing To Your Business
        </h2>
        <p className="text-gray-700 mt-4 leading-relaxed">
        Embrace the latest cloud-based solutions from EMTECH, which will help companies of all sizes to optimize their operations in the current competitive business environment. Our services will help you streamline IT infrastructure costs and reduce operational expenses, enabling you to focus on your core competencies.
        </p>
        
        <p className="text-gray-700 mt-4 leading-relaxed">
        EMTECH is a cloud solution provider in UAE. We specialize in designing, building, and supporting cloud solutions, based on proprietary technology. We are a team of talented professionals, who strive to deliver innovative cloud solutions with world-class expertise.
        </p>
        <button
