...
const ChineseProd = () => {
    ...
    return (
        <>
            <AboutHeroSection page="Chinese Fruits & Vegetables" />

            {/* Display Products */}
            <div className="px-6 md:px-20 py-6">
                <h1 className="text-3xl font-semibold text-center text-gray-800 ">Chinese Products</h1>
