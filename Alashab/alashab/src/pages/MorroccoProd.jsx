...
const MorroccoProd = () => {
    ...
    return (
      <>
            <AboutHeroSection page="Moroccon Fruits & Vegetables" />
            
            {/* Display Products */}
            <div className="px-6 md:px-20 py-6">
              <h1 className="text-3xl font-semibold text-center text-gray-800 ">Moroccon Products</h1>
